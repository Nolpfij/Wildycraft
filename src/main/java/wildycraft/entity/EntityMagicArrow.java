...
public class EntityMagicArrow extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityMagicArrow(World par1World, EntityLivingBase par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityMagicArrow(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var21 = Wildycraft.causeMagicArrowDamage(this, this);
                    }
                    else
                    {
                        var21 = Wildycraft.causeMagicArrowDamage(this, this.shootingEntity);
                    }
            ...
            if (this.getIsCritical())
            {
                ...
                {
                    this.worldObj.spawnParticle("reddust", this.posX + this.motionX, this.posY+ this.motionY, this.posZ + this.motionZ, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
                }
            }
