...
public class EntityDesertWolf extends EntityMob
{
    ...
    public EntityDesertWolf(World par1World)
    {
        ...
        this.tasks.addTask(4, new EntityAIAttackOnCollide(this, 1.3D, true));
        this.tasks.addTask(7, new EntityAIWander(this, 1.0D));
        this.tasks.addTask(9, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
        this.tasks.addTask(9, new EntityAILookIdle(this));
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, true));
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 0, true));
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityCamel.class, 200, true));
    }
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(68.0D);
    }
   ...
   // }
    ...
    {
        return this.rand.nextInt(3) == 0 ? "mob.wolf.growl" : (this.rand.nextInt(3) == 0 ? "mob.wolf.panting" : "mob.wolf.bark");
    }
    ...
    public boolean attackEntityAsMob(Entity par1Entity)
    {
	 	if(super.attackEntityAsMob(par1Entity)){
	 		if(par1Entity instanceof EntityLivingBase){
	 			((EntityLivingBase) par1Entity).addPotionEffect(new PotionEffect(18, 200, 10, false));
	 			this.addPotionEffect(new PotionEffect(5, 200, 0, false));
	 		}
	 		return true;
	 	} else{
	 		return false;
    ...
    {
        return (0.55F - (float)(68 - this.dataWatcher.getWatchableObjectFloat(18)) * 0.005F) * (float)Math.PI;
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        var3 = this.rand.nextInt(2) + 1 + this.rand.nextInt(1 + par2);

        for (var4 = 0; var4 < var3; ++var4)
        {
               this.dropItem(Wildycraft.camelRaw, 1);
               double i = rand.nextInt(100);
               if(i > 70){
               	this.dropItem(Item.getItemFromBlock(Blocks.reeds), 1);
               } else {
