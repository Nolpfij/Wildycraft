...
public class EntityChinchompaProjectile extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityChinchompaProjectile(World par1World)
    {
        super(par1World);
    ...
    public EntityChinchompaProjectile(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityChinchompaProjectile(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par1EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityChinchompaProjectile(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var21 = Wildycraft.causeChinchompaDamage(this, this);
                    }
                    else
                    {
                        var21 = Wildycraft.causeChinchompaDamage(this, this.shootingEntity);
                    }
                    ...
                    if (var4.entityHit.attackEntityFrom(var21, var23))
                    {
                        if (var4.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            if (this.shootingEntity == null)
                            {
                            	worldObj.createExplosion(this, this.posX, this.posY, this.posZ, 2, false);
                            } else {
                            	worldObj.createExplosion(shootingEntity, this.posX, this.posY, this.posZ, 2, false);
                            }
            ...
            /*for (var9 = 0; var9 < 4; ++var9){
                    this.worldObj.spawnParticle("townaura", this.posX + this.motionX * (double)var9 / 4.0D, this.posY + this.motionY * (double)var9 / 4.0D, this.posZ + this.motionZ * (double)var9 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
            }*/
