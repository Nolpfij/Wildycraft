...
public class EntityAIFremTradePlayer extends EntityAIBase
{
    private EntityFremVillager villager;

    public EntityAIFremTradePlayer(EntityFremVillager par1EntityVillager)
    {
