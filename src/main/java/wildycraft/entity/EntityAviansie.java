...
public class EntityAviansie extends EntityMob implements IRangedAttackMob {
	...
	private float rangeDamage = 0;
	 ...
	 public EntityAviansie(World par1World){
	     super(par1World);
	 ...
	 protected void applyEntityAttributes(){
	     ...
	     this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(37.0D);
