...
public class EntityMagicBlast extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityMagicBlast(World par1World)
    {
        super(par1World);
    ...
    public EntityMagicBlast(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityMagicBlast(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par1EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityMagicBlast(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var21 = Wildycraft.causeMagicBlastDamage(this, this);
                    }
                    else
                    {
                        var21 = Wildycraft.causeMagicBlastDamage(this, this.shootingEntity);
                    }
           ...
           // {
                ...
                {
                    this.worldObj.spawnParticle("lava", this.posX + this.motionX * (double)var9 / 4.0D, this.posY + this.motionY * (double)var9 / 4.0D, this.posZ + this.motionZ * (double)var9 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
                }
            //}
