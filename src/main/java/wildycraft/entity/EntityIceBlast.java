...
public class EntityIceBlast extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityIceBlast(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par1EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityIceBlast(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var21 = Wildycraft.causeIceBlastDamage(this, this);
                    }
                    else
                    {
                        var21 = Wildycraft.causeIceBlastDamage(this, this.shootingEntity);
                    }
                    ...
                    if (var4.entityHit.attackEntityFrom(var21, var23))
                    {
                        if (var4.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            var24.addPotionEffect(new PotionEffect(2,200,5,true));
