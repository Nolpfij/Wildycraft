...
public class EntityAICyrisusTradePlayer extends EntityAIBase
{
    private EntityCyrisus villager;

    public EntityAICyrisusTradePlayer(EntityCyrisus par1EntityVillager)
    {
