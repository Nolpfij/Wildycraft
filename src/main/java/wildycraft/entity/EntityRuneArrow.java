...
public class EntityRuneArrow extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = Wildycraft.causeRuneArrowDamage(this, this);
                    }
                    else
                    {
                        damagesource = Wildycraft.causeRuneArrowDamage(this, this.shootingEntity);
                    }
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Wildycraft.runeArrow, 1)))
            {
                flag = false;
            }
