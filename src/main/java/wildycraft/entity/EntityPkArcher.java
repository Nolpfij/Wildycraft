...
public class EntityPkArcher extends EntityMob implements IRangedAttackMob
{
    private EntityAIArrowAttack field_85037_d = new EntityAIArrowAttack(this, 1.0F, 5, 10.0F);
    ...
    public EntityPkArcher(World par1World)
    {
        super(par1World);
    ...
    public void onDeath(DamageSource par1DamageSource) {
		...
		if (par1DamageSource.getEntity() instanceof EntityPlayer){
			...
			//ep.addStat(Nolpcraft.MasterArcher, 1);
		}
	}
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLiving, float par2)
    {
        ...
        var2.setDamage(var2.getDamage() + 0.0D);
        if (var3 > 0)
        {
