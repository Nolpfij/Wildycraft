...
public class EntityCamel extends EntityAnimal
{
    public EntityCamel(World par1World)
    {
        ...
        this.tasks.addTask(2, new EntityAIAvoidEntity(this, EntityDesertWolf.class, 8.0F, 0.3D, 0.6D));
        this.tasks.addTask(3, new EntityAIMate(this, 0.2F));
        this.tasks.addTask(4, new EntityAITempt(this, 0.25F, Items.wheat, false));
    ...
    {
    	EntityCamel temp = new EntityCamel(this.worldObj);
