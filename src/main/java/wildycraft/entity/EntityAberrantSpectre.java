...
public class EntityAberrantSpectre extends EntityMob implements IRangedAttackMob{
	...
	private boolean persistenceRequired = false;
	 ...
	 public EntityAberrantSpectre(World par1World){
	     super(par1World);
	 ...
	 protected void dropFewItems(boolean par1, int par2,
			...
			for (var4 = 0; var4 < var3; ++var4) {
				...
				if (i > 70) {
					this.dropItem(Items.wheat_seeds, rand.nextInt(6) + 1);
				} else if (i > 60){
					this.dropItem(Items.pumpkin_seeds, rand.nextInt(6) + 1);
				}else if (i > 45){
					this.dropItem(Items.melon_seeds, rand.nextInt(6) + 1);
				}else if (i > 37){
					this.dropItem(Item.getItemFromBlock(Blocks.red_mushroom), rand.nextInt(4) + 1);
				}else if (i > 29){
					this.dropItem(Wildycraft.fireRune,5);
				}else if (i > 8){
					this.dropItem(Items.experience_bottle,3);
				}else {
					this.dropItem(Wildycraft.darkMysticRobeBottom,1);
				}
			}
		}
	 ...
	 public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLiving,
				...
				var2.setDamage(var2.getDamage() + 5);
