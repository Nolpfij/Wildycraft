...
public class EntityWarTortoise extends EntityTameable implements RSFamiliar,
		IInventory {
	...
	public EntityWarTortoise(World par1World) {
		super(par1World);
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		if (var2 != null && par1EntityPlayer.isSneaking()
				...
				&& this.dataWatcher.getWatchableObjectFloat(18) < 1000) {
			...
			return true;
		} else if (var2 != null && par1EntityPlayer.isSneaking() && var2.getItem() == Wildycraft.testudoScroll){
       	 	if (!par1EntityPlayer.capabilities.isCreativeMode)
       	 	{
       	 		--var2.stackSize;
       	 	}
    	 
    		par1EntityPlayer.addPotionEffect(new PotionEffect(11,600,0,false));
	 ...
	 */
	public EntityWarTortoise spawnBabyAnimal(EntityAgeable par1EntityAgeable) {
		EntityWarTortoise var2 = new EntityWarTortoise(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal) {
		if (par1EntityAnimal == this) {
			...
			return false;
		} else if (!(par1EntityAnimal instanceof EntityWarTortoise)) {
			return false;
		} else {
			EntityWarTortoise var2 = (EntityWarTortoise) par1EntityAnimal;
