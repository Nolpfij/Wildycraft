...
public class EntityRockCrab extends EntityMob {
	public EntityRockCrab(World par1World) {
		super(par1World);
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		int var3 = 1 + rand.nextInt(par2 + 1);
		int var4;
		for (var4 = 0; var4 < var3; ++var4) {
			double i = Math.random() * 100;
			if (i > 99) {
				this.dropItem(Wildycraft.runepick, 1);
			} else if (i > 95) {
				...
				this.dropItem(Wildycraft.fireRune, 7);
			}
		}
	}
