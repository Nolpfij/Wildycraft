...
public class EntityYak extends EntityAnimal
{
    public EntityYak(World par1World)
    {
        super(par1World);
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (var4 = 0; var4 < var3; ++var4)
        {
            if (this.isBurning())
            {
                this.dropItem(Wildycraft.yakMeatCooked, 1);
            }
            else
            {
                this.dropItem(Wildycraft.yakMeatRaw, 1);
            }
        }
        this.dropItem(Wildycraft.yakhide,2);
    }
     ...
     */
    public EntityYak spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
    	EntityYak temp = new EntityYak(this.worldObj);
