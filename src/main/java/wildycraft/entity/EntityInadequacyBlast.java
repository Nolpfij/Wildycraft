...
public class EntityInadequacyBlast extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityInadequacyBlast(World par1World)
    {
        super(par1World);
    ...
    public EntityInadequacyBlast(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityInadequacyBlast(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par1EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        ...
        double var6 = par1EntityLiving.posX - par2EntityLiving.posX;
        double var8 = par1EntityLiving.posY + (double)par1EntityLiving.getEyeHeight() - 0.699999988079071D - this.posY;
        double var10 = par1EntityLiving.posZ - par2EntityLiving.posZ;
    ...
    public EntityInadequacyBlast(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var21 = Wildycraft.causeFearDamage(this, this);
                    }
                    else
                    {
                        var21 = Wildycraft.causeFearDamage(this, this.shootingEntity);
                    }
                    ...
                    if (!(var4.entityHit instanceof EntityDreamMonster) && var4.entityHit.attackEntityFrom(var21, var23))
                    {
                        if (var4.entityHit instanceof EntityLivingBase)
                        {
                            EntityLivingBase var24 = (EntityLivingBase)var4.entityHit;
                            if(var24.getActivePotionEffect(Wildycraft.fear)!= null){
                            	int level = var24.getActivePotionEffect(Wildycraft.fear).getAmplifier() + 1;
                            	var24.addPotionEffect(new PotionEffect(44,2400,level,true));
                            } else {
                            	var24.addPotionEffect(new PotionEffect(44,2400,0,true));
                            }
                        ...
                        this.setDead();
                        this.playSound("random.explode1", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
            ...
            //{
                ...
                {
                    this.worldObj.spawnParticle("smoke", this.posX + this.motionX * (double)var9 / 4.0D, this.posY + this.motionY * (double)var9 / 4.0D, this.posZ + this.motionZ * (double)var9 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
                }
            //}
