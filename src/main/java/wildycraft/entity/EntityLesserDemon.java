...
public class EntityLesserDemon extends EntityMob implements EntityZamorakianDemon{
	 ...
	 protected void dropFewItems(boolean par1, int par2,
			...
			for (var4 = 0; var4 < var3; ++var4) {
				...
				if (i > 95) {
					...
					this.dropItem(Wildycraft.MithrilChestPlate, 1);
				} else if (i > 80) {
					this.dropItem(Wildycraft.bootsOfLightness, 1);
				} else if (i > 60) {
					this.dropItem(Item.getItemFromBlock(Blocks.gold_ore), 1);
				} else if (i > 45) {
					this.dropItem(Wildycraft.fireRune, 30);
				} else if (i > 25) {
					...
					this.dropItem(Item.getItemFromBlock(Blocks.torch),10);
				} else {
