...
public class EntityDragonfire extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityDragonfire(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityDragonfire(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par1EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityDragonfire(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var21 = Wildycraft.causeDragonfireDamage();
                    }
                    else
                    {
                        var21 = Wildycraft.causeDragonfireDamage();
            ...
            //if (this.getIsCritical())
           // {
            for (var9 = 0; var9 < 160; ++var9)
            {
            	float p = rand.nextFloat()*2*(float)Math.PI;
            	float r = rand.nextFloat()*2*(float)Math.PI;
                this.worldObj.spawnParticle("flame", this.posX + 0.6f*MathHelper.sin(p)*MathHelper.cos(r), this.posY + 0.6f*MathHelper.sin(p)*MathHelper.sin(r), this.posZ + 0.6f*MathHelper.cos(p), this.motionX, this.motionY, this.motionZ);
            }
           // }
