...
public class EntityAILunarVillagerMate extends EntityAIBase
{
    private EntityLunarVillager villagerObj;
    private EntityLunarVillager mate;
    private World worldObj;
    private int matingTimeout;
    Village villageObj;

    public EntityAILunarVillagerMate(EntityLunarVillager par1EntityVillager)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            {
                Entity entity = this.worldObj.findNearestEntityWithinAABB(EntityLunarVillager.class, this.villagerObj.boundingBox.expand(8.0D, 3.0D, 8.0D), this.villagerObj);
                ...
                {
                    this.mate = (EntityLunarVillager)entity;
    ...
    {
        EntityLunarVillager entityvillager = this.villagerObj.func_90012_b(this.mate);
