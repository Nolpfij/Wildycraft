...
public class EntityDreadFowl extends EntityTameable implements IRangedAttackMob,RSFamiliar
{
    ...
    private EntityAIArrowAttack field_85037_d = new EntityAIArrowAttack(this, 0.25F, 30, 10.0F);
    ...
    public EntityDreadFowl(World par1World)
    {
        super(par1World);
        ...
        this.tasks.addTask(3, this.field_85037_d);
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (this.isTamed())
        {
            if (var2 != null)
            {
                if (var2.getItem() instanceof Item)
                {
                    Item var3 = (Item)var2.getItem();

                    if (var3 == Items.wheat && this.dataWatcher.getWatchableObjectFloat(18) < 30)
                    {
                        ...
                        return true;
                    } else if (var3 == Wildycraft.dreadfowlStrikeScroll){
                    	if(getHowlDelay() == 0){
                    		setHowlDelay(60);
                    	 if (!par1EntityPlayer.capabilities.isCreativeMode)
                         {
                    	 ...
                    	 for (int i = 0; i < 30; i++){
                    		 EntityAirBlast v2 = new EntityAirBlast(this.worldObj, this, 1.6F);
                    		 v2.setKnockbackStrength(1);
                    		 v2.setDamage(v2.getDamage());
    ...
    {
        return (0.55F - (float)(80 - this.dataWatcher.getWatchableObjectInt(18)) * 0.005F) * (float)Math.PI;
    }
     ...
     */
    public EntityDreadFowl spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityDreadFowl var2 = new EntityDreadFowl(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityDreadFowl))
        {
            return false;
        }
        else
        {
            EntityDreadFowl var2 = (EntityDreadFowl)par1EntityAnimal;
	...
	@Override
	public void attackEntityWithRangedAttack(EntityLivingBase var1, float par2) {
		// TODO Auto-generated method stub 
		EntityAirBlast var2 = new EntityAirBlast(this.worldObj, this, var1, 1.6F, 12.0F);
        ...
        var2.setDamage(var2.getDamage() + 3.0D);
