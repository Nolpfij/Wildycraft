...
public class EntityBloodBlast extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    private double leech = 0.05D;

    /** The amount of knockback an arrow applies when it hits a mob. */
    private int knockbackStrength;

    public EntityBloodBlast(World par1World)
    {
        super(par1World);
    ...
    public EntityBloodBlast(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityBloodBlast(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par1EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityBloodBlast(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var21 = Wildycraft.causeBloodBlastDamage(this, this);
                    }
                    else
                    {
                        var21 = Wildycraft.causeBloodBlastDamage(this, this.shootingEntity);
                    }
                        ...
                        if (var4.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            if (this.shootingEntity instanceof EntityLivingBase)
                            {
                            	if(this.shootingEntity instanceof EntityPlayer){
                            		((EntityLivingBase) shootingEntity).heal((int)Math.round(var23 / 20));
                            	} else {
                            		((EntityLivingBase) shootingEntity).heal((int)Math.round(var23 / 5));
                            	}
                            }
