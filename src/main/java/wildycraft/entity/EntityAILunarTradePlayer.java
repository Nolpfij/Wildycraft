...
public class EntityAILunarTradePlayer extends EntityAIBase
{
    private EntityLunarVillager villager;

    public EntityAILunarTradePlayer(EntityLunarVillager par1EntityVillager)
    {
