...
public class EntityAIFremVillagerMate extends EntityAIBase
{
    private EntityFremVillager villagerObj;
    private EntityFremVillager mate;
    private World worldObj;
    private int matingTimeout;
    Village villageObj;

    public EntityAIFremVillagerMate(EntityFremVillager par1EntityVillager)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            {
                Entity entity = this.worldObj.findNearestEntityWithinAABB(EntityFremVillager.class, this.villagerObj.boundingBox.expand(8.0D, 3.0D, 8.0D), this.villagerObj);
                ...
                {
                    this.mate = (EntityFremVillager)entity;
    ...
    {
        EntityFremVillager entityvillager = this.villagerObj.func_90012_b(this.mate);
