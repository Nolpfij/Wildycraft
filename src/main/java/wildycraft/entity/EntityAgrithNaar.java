...
public class EntityAgrithNaar extends EntityMob{
	
	private int jumpTicks = 0;
	
	private boolean persistenceRequired = false;
	
	 public EntityAgrithNaar(World par1World){
	     super(par1World);
	 ...
	 protected void dropFewItems(boolean par1, int par2,
			...
			for (var4 = 0; var4 < var3; ++var4) {
				...
				if (i > 95) {
					...
					this.dropItem(Items.lava_bucket,3);
				}
			}
		}
	 ...
	 {
	    return this.posY < 40 && super.getCanSpawnHere();
	 }
}
