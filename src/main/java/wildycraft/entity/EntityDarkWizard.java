...
public class EntityDarkWizard extends EntityMob implements IRangedAttackMob {
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		for (var4 = 0; var4 < var3; ++var4) {
			...
			if (j > 97.5) {
				...
				this.dropItem(Wildycraft.fireRune, 10);
			} else if (j > 50) {

				this.dropItem(Wildycraft.waterRune, 10);
			} else if (j > 25) {

				this.dropItem(Wildycraft.earthRune, 10);
			} else {
				this.dropItem(Wildycraft.airRune, 10);
			}
	...
	public void setCombatTask() {
		...
		if (var1 != null
				&& (var1.getItem() == Wildycraft.Staff
						|| var1.getItem() == Wildycraft.AirStaff
						|| var1.getItem() == Wildycraft.IceStaff || var1.getItem() == Wildycraft.EarthStaff)) {
			this.tasks.addTask(4, this.field_85037_d);
		} else {
	...
	public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLiving,
		...
		if (type > 3) {
			...
			EntityEarthBlast var2 = new EntityEarthBlast(this.worldObj, this,
					par1EntityLiving, 1.6F, 2.0F);
			int var3 = EnchantmentHelper.getEnchantmentLevel(
					Enchantment.power.effectId, this.getHeldItem());
			int var4 = EnchantmentHelper.getEnchantmentLevel(
