...
public class GuiRSInventory extends GuiContainer {
	/**
	...
	private static final ResourceLocation iconLocation = new ResourceLocation(
			"nolpfij_wildycraft", "textures/gui/rs_inventory.png");

	/**
	 * Could use IInventory type to be more generic, but this way will save an
	 * import...
	 */
	private final InventoryExtendedRS inventory;

	public GuiRSInventory(EntityPlayer player, InventoryPlayer inventoryPlayer,
			InventoryExtendedRS inventoryCustom) {
		super(new ContainerRSPlayer(player, inventoryPlayer, inventoryCustom));
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		String s = "\u00A7f" + this.inventory.getInventoryName();
		// with the name "Custom Inventory", the 'Cu' will be drawn in the first
		// slot
		
		this.fontRendererObj.drawString(s,
				this.xSize/2 - this.fontRendererObj.getStringWidth(s)/2, -9, 4210752);
		s = "Amulet";
		this.fontRendererObj.drawString(s,
				100, 12, 4210752);
		s = "Shield";
		...
		//this.fontRendererObj.drawString(I18n.getString("container.inventory"), 80,
	 ...
	 */
	public static void drawPlayerModel(int x, int y, int scale, float yaw,
