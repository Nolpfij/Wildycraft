...
public class MysticStaffEarth extends ItemBow
{
    public MysticStaffEarth()
    {
        super();
        this.maxStackSize = 1;
    ...
    public IIcon getIcon(ItemStack stack,int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining){
    	if (usingItem != null && usingItem.getItem() == Wildycraft.MysticEarthStaff)
        {
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
       ...
       // boolean x = true;
        ...
        if (var5 || par3EntityPlayer.inventory.hasItem(Wildycraft.earthRune))
        {
            ...
            var8.setDamage(var8.getDamage() + 35);
            if (var9 > 0)
            {
