...
public class AncientStaffBlood extends ItemBow
{
    public AncientStaffBlood()
    {
        super();
        this.maxStackSize = 1;
    ...
    public IIcon getIcon(ItemStack stack,int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining){
    	if (usingItem != null && usingItem.getItem() == Wildycraft.AncientBloodStaff)
        {
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
       ...
       // boolean x = true;
        ...
        if (var5 || (par3EntityPlayer.inventory
            ...
            EntityBloodBlast var8 = new EntityBloodBlast(par2World, par3EntityPlayer, var7);
            ...
            else
            {
            	if (i%3 == 0){
            		...
            		par3EntityPlayer.inventory.consumeInventoryItem(Wildycraft.bloodRune);
            	}
            }
            ...
            if (!par2World.isRemote)
            {
                ...
                par3EntityPlayer.addStat(Wildycraft.BloodWizard,1);
            }
        }
        }
    }
