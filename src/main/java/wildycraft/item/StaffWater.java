...
public class StaffWater extends ItemBow
{
    public StaffWater()
    {
        super();
    ...
    public IIcon getIcon(ItemStack stack,int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining){
    	if (usingItem != null && usingItem.getItem() == Wildycraft.IceStaff)
        {
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
       ...
       // boolean x = true;
        if (var5 || par3EntityPlayer.inventory.hasItem(Wildycraft.waterRune))
        {
            ...
            if (!par2World.isRemote)
            {
                ...
                par3EntityPlayer.addStat(Wildycraft.WaterWizard,1);
            }
        }
    }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Wildycraft.waterRune))
        {
