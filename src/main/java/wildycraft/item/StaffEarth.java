...
public class StaffEarth extends ItemBow
{
    public StaffEarth()
    {
        super();
        this.maxStackSize = 1;
        this.setMaxDamage(300);//How many times you can shoot arrows
    ...
    public IIcon getIcon(ItemStack stack,int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining){
    	if (usingItem != null && usingItem.getItem() == Wildycraft.EarthStaff)
        {
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
       ...
       // boolean x = true;
        if (var5 || par3EntityPlayer.inventory.hasItem(Wildycraft.earthRune))
        {
            ...
            if (!par2World.isRemote)
            {
                ...
                par3EntityPlayer.addStat(Wildycraft.EarthWizard,1);
            }
        }
    }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Wildycraft.earthRune))
        {
