...
public class StaffWeaken extends ItemBow
{
    public StaffWeaken()
    {
        super();
    ...
    public IIcon getIcon(ItemStack stack,int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining){
    	if (usingItem != null && usingItem.getItem() == Wildycraft.WeakenStaff)
        {
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
       ...
       // boolean x = true;
        if (var5 || (par3EntityPlayer.inventory.hasItem(Wildycraft.bodyRune) && par3EntityPlayer.inventory.hasItem(Wildycraft.waterRune)&& par3EntityPlayer.inventory.hasItem(Wildycraft.earthRune)))
        {
            ...
            EntityWeakenBlast var8 = new EntityWeakenBlast(par2World, par3EntityPlayer, var7);
            ...
            {
            	par3EntityPlayer.inventory.consumeInventoryItem(Wildycraft.waterRune);
            	par3EntityPlayer.inventory.consumeInventoryItem(Wildycraft.earthRune);
                par3EntityPlayer.inventory.consumeInventoryItem(Wildycraft.bodyRune);
            }
            ...
            if (!par2World.isRemote)
            {
                ...
                par3EntityPlayer.addStat(Wildycraft.SupportWizard,1);
            }
        }
    }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.capabilities.isCreativeMode || (par3EntityPlayer.inventory.hasItem(Wildycraft.bodyRune) && par3EntityPlayer.inventory.hasItem(Wildycraft.waterRune)&& par3EntityPlayer.inventory.hasItem(Wildycraft.earthRune)))
        {
