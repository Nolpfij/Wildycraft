...
public class ZaryteBow extends ItemBow
{
    public ZaryteBow()
    {
        super();
        this.maxStackSize = 1;
        this.setMaxDamage(7000);//How many times you can shoot arrows
    ...
    public IIcon getIcon(ItemStack stack,int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining){
    	if (usingItem != null && usingItem.getItem() == Wildycraft.Zaryte)
        {
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (x)
        {
           ...
           if ((double)var7 < 0.1D)
            ...
            EntityMagicArrow var8 = new EntityMagicArrow(par2World, par3EntityPlayer, var7 );
