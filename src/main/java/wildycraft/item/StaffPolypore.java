...
public class StaffPolypore extends ItemBow
{
    public StaffPolypore()
    {
        super();
        this.maxStackSize = 1;
    ...
    public IIcon getIcon(ItemStack stack,int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining){
    	if (usingItem != null && usingItem.getItem() == Wildycraft.PolyporeStaff)
        {
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
       ...
       // boolean x = true;
        if (var5 || (par3EntityPlayer.inventory
				.hasItem(Wildycraft.fireRune) && (par3EntityPlayer.inventory
								.hasItem(Item.getItemFromBlock(Blocks.brown_mushroom)) || par3EntityPlayer.inventory
								.hasItem(Item.getItemFromBlock(Blocks.red_mushroom)))))
        {
            ...
            EntityPolyporeBlast var8 = new EntityPolyporeBlast(par2World, par3EntityPlayer, var7);
            ...
            var8.setDamage(var8.getDamage() + 5);
            if (var9 > 0)
            {
            ...
            else
            {
            	...
            	if (par3EntityPlayer.inventory
						.hasItem(Item.getItemFromBlock(Blocks.brown_mushroom))){
            		par3EntityPlayer.inventory.consumeInventoryItem(Item.getItemFromBlock(Blocks.brown_mushroom));
            	} else {
            		par3EntityPlayer.inventory.consumeInventoryItem(Item.getItemFromBlock(Blocks.red_mushroom));
            	}
            }
            ...
            if (!par2World.isRemote)
            {
                ...
                par3EntityPlayer.addStat(Wildycraft.PolyporeWizard,1);
            }
        }
    }
