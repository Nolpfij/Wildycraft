...
public class DreamPotion extends Item {
	public DreamPotion() {
		super();
	...
	public boolean onItemUse(ItemStack par1ItemStack,
		...
		if (!par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7,
			...
			if (var11 == Blocks.fire && var12 == Wildycraft.brazier) {
				if (par3World.isRemote == false) {
					TileEntityBrazier teb = (TileEntityBrazier) par3World.getTileEntity(par4, par5 - 1, par6);
					teb.startCountdown();
				}
