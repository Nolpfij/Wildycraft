...
{
	public static ResourceLocation texture = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/KrilTsutsaroth.png");
	...
	public RenderKrilTsutsaroth(ModelKrilTsutsaroth par1)
    {
        super(par1, 0.5F);
		modelBipedMain = par1;
    }
    ...
    protected void func_82438_a(EntityKrilTsutsaroth par1EntitySkeleton, float par2)
    {
    	BossStatus.setBossStatus(par1EntitySkeleton, true);
    ...
    {
        this.func_82438_a((EntityKrilTsutsaroth)par1EntityLiving, par2);
    }
	...
	protected void renderEquippedItems(EntityLivingBase par1EntityLiving,
		...
		if (var4 != null) {
			...
			this.modelBipedMain.rightlowarm.postRender(0.0625F);

			var6 = 2.0F;

			GL11.glTranslatef(-0.39375F, -2.6F, -0.8F);
			...
			this.modelBipedMain.leftlowarm.postRender(0.0625F);
