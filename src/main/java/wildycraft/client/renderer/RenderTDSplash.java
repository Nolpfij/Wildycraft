...
public class RenderTDSplash extends Render
{
	public static ResourceLocation texture = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/fireblast.png");
    public void renderArrow(EntityTDSplash par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        GL11.glScalef(var20/2, var20, var20);
    ...
    {
        this.renderArrow((EntityTDSplash)par1Entity, par2, par4, par6, par8, par9);
    }
