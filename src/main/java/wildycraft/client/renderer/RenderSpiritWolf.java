...
{
	public static ResourceLocation texture = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/spiritwolf.png");
    ...
    protected float getTailRotation(EntitySpiritWolf par1EntityWolf, float par2)
    {
        return par1EntityWolf.getTailRotation();
    }

    protected int func_82447_a(EntitySpiritWolf par1EntityWolf, int par2, float par3)
    {
        float var4;
    ...
    {
        return this.func_82447_a((EntitySpiritWolf)par1EntityLiving, par2, par3);
    }
    ...
    {
        return this.getTailRotation((EntitySpiritWolf)par1EntityLiving, par2);
    }
