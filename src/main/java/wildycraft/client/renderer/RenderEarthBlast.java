...
public class RenderEarthBlast extends Render
{
	public static ResourceLocation texture = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/earthblast.png");
    public void renderArrow(EntityEarthBlast par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderArrow((EntityEarthBlast)par1Entity, par2, par4, par6, par8, par9);
    }
