...
public class RenderMonsterExamine extends Render
{
    private MonsterExamineBook book;
    private int field_94150_f;
    private static final String __OBFID = "CL_00001008";

    public RenderMonsterExamine(MonsterExamineBook par1Item)
    {
        this.book = par1Item;
    }
    ...
    {
        IIcon iicon = this.book.itemIcon2;
