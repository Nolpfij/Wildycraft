...
public class RenderRegularTablet extends Render
{
    private ItemTablet tablet;
    private int field_94150_f;
    private static final String __OBFID = "CL_00001008";

    public RenderRegularTablet(ItemTablet par1Item)
    {
        this.tablet = par1Item;
    }
    ...
    {
        IIcon iicon = this.tablet.getIconFromType(((EntityTabletSpell) par1Entity).getType());
