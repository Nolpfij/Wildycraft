...
public class RenderPolypore extends Render
{
	public static ResourceLocation texture = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/polyporeblast.png");
    public void renderArrow(EntityPolyporeBlast par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderArrow((EntityPolyporeBlast)par1Entity, par2, par4, par6, par8, par9);
    }
