...
{
	public static ResourceLocation bk = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/darkknight.png");
	public static ResourceLocation wk = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/whiteknight.png");
    ...
    {
    	if(par1EntityLiving instanceof EntityBlackKnight){
    		return bk;
    	} else if(par1EntityLiving instanceof EntityWhiteKnight){
    		return wk;
    	}else if(par1EntityLiving instanceof EntityPker){
    		return new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs" + ((EntityPker) par1EntityLiving).getTexture());
    	}
        return null;
    }
}
