...
{
	public static ResourceLocation texture = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/desertwolf.png");
    ...
    protected float getTailRotation(EntityDesertWolf par1EntityWolf, float par2)
    {
        return par1EntityWolf.getTailRotation();
    }

    protected int func_82447_a(EntityDesertWolf par1EntityWolf, int par2, float par3)
    {
        float var4;
