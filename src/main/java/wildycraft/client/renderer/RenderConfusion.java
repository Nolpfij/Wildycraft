...
public class RenderConfusion extends Render
{
	public static ResourceLocation texture = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/confuse.png");
    public void renderArrow(EntityWeakenBlast par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderArrow((EntityWeakenBlast)par1Entity, par2, par4, par6, par8, par9);
    }
