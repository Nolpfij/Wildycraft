...
import wildycraft.client.model.ModelRSVillager;
...
public class RenderRSVillager extends RenderLiving
{
	public static ResourceLocation texture = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/FremVillager.png");
	public static ResourceLocation texture2 = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/LunarVillager.png");
	public static ResourceLocation texture3 = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/Cyrisus.png");
	protected ModelRSVillager modelBipedMain;
	public RenderRSVillager()
    {
       this(new ModelRSVillager());
    }
	
	public RenderRSVillager(ModelRSVillager par1)
    {
        super(par1, 0.5F);
        modelBipedMain = par1;
    }

    protected void func_82438_a(EntityLivingBase par1EntitySkeleton, float par2)
    {
    ...
    {
        this.func_82438_a((EntityLivingBase)par1EntityLiving, par2);
    }
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		if(entity instanceof EntityLunarVillager){
			return texture2;
		}
		if(entity instanceof EntityCyrisus){
			return texture3;
		}
