...
public class RenderNechryael extends RenderLiving
{
	public static ResourceLocation texture = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/Nechryael.png");
	public static ResourceLocation texture2 = new ResourceLocation(Wildycraft.modid + ":" + "textures/mobs/DeathSpawn.png");
	protected ModelBiped modelBipedMain;
	public RenderNechryael()
    {
       this(new ModelBiped(0.0F, 0.0F, 64, 64));
    }
	
	public RenderNechryael(ModelBiped par1)
    {
        super(par1, 0.5F);
        modelBipedMain = par1;
    }

    protected void func_82438_a(Entity par1EntitySkeleton, float par2)
    {
    	if(par1EntitySkeleton instanceof EntityDeathSpawn){
    ...
    {
        this.func_82438_a((Entity)par1EntityLiving, par2);
    }
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		...
		if(entity instanceof EntityNechryael){
			return texture;
		} else {
			return texture2;
		}
