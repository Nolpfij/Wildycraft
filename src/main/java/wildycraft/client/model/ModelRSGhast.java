...
{
    ModelRenderer body;
    ModelRenderer[] tentacles = new ModelRenderer[4];

    public ModelRSGhast()
    {
        byte var1 = -16;
        this.body = new ModelRenderer(this, 0, 0);
        this.body.addBox(-5.0F, 0.0F, -14.0F, 8, 8, 18);
        ...
        for (int var3 = 0; var3 < this.tentacles.length; ++var3)
        {
            ...
            float var4 = (((float)(var3 % 2) - (float)(var3 / 2 % 1) * 0.5F + 0.25F) / 2.0F * 2.0F - 1.0F) * 5.0F;
            float var5 = ((float)(var3 / 2) / 2.0F * 2.0F - 1.0F) * 10.0F;
            int var6 = 8;
