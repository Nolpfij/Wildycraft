...
public class WorldGenRSMinable extends WorldGenerator
{
    ...
    public WorldGenRSMinable(Block par1, int par2)
    {
        this(par1, par2, Blocks.stone);
    }

    public WorldGenRSMinable(Block par1, int par2, Block par3)
    {
    ...
    public WorldGenRSMinable(Block id, int meta, int number, Block target)
    {
