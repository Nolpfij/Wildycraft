...
public class WorldGenRSMagicTree extends WorldGenerator {
	...
	public WorldGenRSMagicTree(boolean par1) {
		this(par1, 6, 0, 0, false);
	}

	public WorldGenRSMagicTree(boolean par1, int par2, int par3, int par4,
			boolean par5) {
		super(par1);
