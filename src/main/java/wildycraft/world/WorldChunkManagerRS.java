...
public class WorldChunkManagerRS extends WorldChunkManager
{
        ...
        protected WorldChunkManagerRS()
        {
        	biomeCache = new BiomeCache(this);
        	this.biomesToSpawnIn = new ArrayList();
            this.biomesToSpawnIn.add(Wildycraft.rsDesert);
            this.biomesToSpawnIn.add(Wildycraft.rsForest);
            this.biomesToSpawnIn.add(Wildycraft.rsWildy);
            this.biomesToSpawnIn.add(Wildycraft.rsSnow);
        }

        public WorldChunkManagerRS(long par1, WorldType par3WorldType)
        {
                this();
                GenLayer[] var4 = GenLayerRS.initializeAllBiomeGenerators(par1, par3WorldType);
                this.genBiomes = var4[0];
                this.biomeIndexLayer = var4[1];
        }

        public WorldChunkManagerRS(World par1World)
        {
        ...
        {
                return (BiomeGenBase) biomeCache.getBiomeGenAt(par1, par2);
        }
        ...
        /*public float[] getTemperatures(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
        {
                ...
                for (int var7 = 0; var7 < par4 * par5; ++var7)
                {
                        float var8 = (float)BiomeGenBase.getBiome(var6[var7]).getIntTemperature() / 65536.0F;
        ...
        public BiomeGenBase[] getBiomeGenAt(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5, boolean par6)
        {
                ...
                {
                        BiomeGenBase[] var9 = (BiomeGenBase[]) this.biomeCache.getCachedBiomes(par2, par3);
