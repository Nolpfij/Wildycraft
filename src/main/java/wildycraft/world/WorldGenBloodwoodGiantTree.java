...
public class WorldGenBloodwoodGiantTree extends WorldGenerator
{
    /**
    ...
    public WorldGenBloodwoodGiantTree(boolean par1)
    {
        super(par1);
    }
    ...
    void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, Block par3)
    {
        ...
        if (var4[var6] != 0)
        {
            ...
            for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
            {
                ...
                this.func_150515_a(this.worldObj, var14[0], var14[1], var14[2], par3);
            }
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(var5, var6, Wildycraft.rsWood);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, Wildycraft.rsWood);
            }
        }
    }
