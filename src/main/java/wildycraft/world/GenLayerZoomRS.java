...
public class GenLayerZoomRS extends GenLayer
{
    public GenLayerZoomRS(long par1, GenLayer par3GenLayer)
    {
        super(par1);
    ...
    public static GenLayer magnify(long par0, GenLayer par2GenLayer, int par3)
    {
        ...
        {
            object = new GenLayerZoomRS(par0 + (long)k, (GenLayer)object);
        }
