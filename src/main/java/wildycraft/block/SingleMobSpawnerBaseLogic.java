...
public abstract class SingleMobSpawnerBaseLogic extends MobSpawnerBaseLogic
{
        ...
        if (this.isActivated())
        {
            ...
            else
            {
                ...
                for (int i = 0; i < this.spawnCount; ++i)
                {
                    ...
                    double d3 = (double)this.getSpawnerY();
                    ...
                    if(getSpawnerWorld().difficultySetting.getDifficultyId() > 0){
                ...
                if (flag)
                {
                	this.getSpawnerWorld().setBlock(this.getSpawnerX(), this.getSpawnerY(), this.getSpawnerZ(), Blocks.air);
                    this.resetTimer();
                }
            }
        }
